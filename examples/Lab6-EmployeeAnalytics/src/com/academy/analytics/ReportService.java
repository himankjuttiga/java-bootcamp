...
public class ReportService {
    ...
    public void displayBonusInsights() {
        ...
        System.out.println("Second Highest Salary : "
                + employeeService.findSecondHighestSalary().orElse(0.0));
        employeeService.findEmployeeWithLongestName()
                .ifPresent(e -> System.out.println("Longest Name : " + e.getName()));
        employeeService.findDepartmentWithHighestAverageSalary()
                .ifPresent(d -> System.out.println("Highest Average Salary Department : " + d));
        System.out.println("Salary Histogram : " + employeeService.generateSalaryHistogram());
        System.out.println("Employee Summary : " + employeeService.collectEmployeeSummary());
    }
}