...
public class DefaultCustomerService implements CustomerService {
    ...
    public List<Customer> listAll() {
        return List.copyOf(repository.findAll());   // caller cannot mutate storage
    }
    ...
    public Customer changeStatus(String customerId, CustomerStatus newStatus, String correlationId) {
        ...
        validator.validateTransition(existing.getStatus(), newStatus, correlationId); // validate BEFORE mutating
