...
public class CustomerValidator {
    ...
    /**
     * Lab 16 refactor: an illegal transition is a business conflict, not a raw
     * IllegalStateException. The correlation id rides on the exception so the
     * handler can echo it without repeating it in the message.
     */
